...
async function personal(chatterPlayer, arguments, bot) {
    ...
    if (arguments == null || arguments == "") {
        bot.sendGameMessage("Cette commande permet de récupérer les scores d'un joueur. Cette commande prend en paramètre une catégorie (wpm, reactionTime et precision), un ordre (asc ou desc) et un entier pour définir la limite voulue. Si vous souhaitez simplement visualiser vos scores récents, mettez '$rp all' en paramètre")
