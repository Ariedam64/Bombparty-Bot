async function occurrenceSyllable(arguments, bot) {
    ...
    if (arguments == "" || arguments == null) {
        ...
        bot.sendGameMessage('Utilisation: $occurrenceSyllable fr "er"')
    }
    else if (arguments.split(" ").length > 2) {
        bot.sendGameMessage('Vous avez fourni trop de paramètres. Utilisez la commande "$occurrenceSyllable" pour mieux comprendre son utilisation')
    }
    else if (arguments.split(" ").length < 2) {
        bot.sendGameMessage('Vous n\'avez pas fourni assez de paramètres. Utilisez la commande "$occurrenceSyllable" pour mieux comprendre son utilisation')
    }
        ...
        bot.sendGameMessage('Vous avez fourni une syllabe sans guillemet. Utilisez la commande "$occurrenceSyllable" pour mieux comprendre son utilisation')
    }
    else {
