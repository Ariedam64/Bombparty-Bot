async function occurrenceWord(chatterPlayer, arguments, bot) {
    ...
    if (arguments == "" || arguments == null) {
        ...
        bot.sendGameMessage('Utilisation: $occurrenceWord fr "manger" OU $dow fr "manger"')
    }
    else if (arguments.split(" ").length > 2) {
        bot.sendGameMessage('Vous avez fourni trop de paramètres. Utilisez la commande "$occurrenceWord" ou "$dow" pour mieux comprendre son utilisation')
    }
    else if (arguments.split(" ").length < 2) {
        bot.sendGameMessage('Vous n\'avez pas fourni assez de paramètres. Utilisez la commande "$occurrenceWord" ou "$dow" pour mieux comprendre son utilisation')
    }
        ...
        bot.sendGameMessage('Vous avez fourni un mot sans guillemet. Utilisez la commande "$occurrenceWord" ou "$dow" pour mieux comprendre son utilisation')
    }
    else {
