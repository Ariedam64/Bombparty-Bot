...
function help(chatterPlayer, arguments, bot) {
    ...
    if (chatterPlayer.auth == null || !bot.get_playerStaff().includes(chatterPlayer.auth.id) && chatterPlayer.auth.id != bot.get_creatorId()) {
        ...
        bot.sendGameMessage('𝗥𝗼𝗼𝗺 𝗰𝗼𝗺𝗺𝗮𝗻𝗱𝘀: 𝖺𝗅𝗅𝖯𝗅𝖺𝗒𝖾𝗋𝗌(𝗋𝖺𝗉) — 𝖻𝖺𝗇(𝗋𝖻) — 𝖽𝗂𝗌𝖼𝗈𝗇𝗇𝖾𝖼𝗍(𝗋𝖽) — 𝗀𝖺𝗆𝖾𝗆𝗈𝖽𝖾(𝗋𝗀) — 𝗄𝗂𝖼𝗄(𝗋𝗄) — 𝗅𝖾𝖺𝖽(𝗋𝗅) — 𝗆𝗈𝖽(𝗋𝗆) — 𝗌𝖾𝖺𝗋𝖼𝗁𝖬𝖾𝗌𝗌𝖺𝗀𝖾(𝗋𝗌𝗆) - 𝗎𝗇𝖻𝖺𝗇(𝗋𝗎𝖻) - 𝗎𝗇𝗆𝗈𝖽(𝗋𝗎𝗆) - 𝗋𝖾𝖺𝗅𝖳𝗂𝗆𝖾𝖨𝗇𝖿𝗈𝗋𝗆𝖺𝗍𝗂𝗈𝗇(𝗋𝗋)')
