...
Mayaya:`;
    ...
    try {
        ...
        const model = new OpenAI({ openAIApiKey: "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", modelName: "gpt-3.5-turbo-16k", temperature:1 });
        ...
        const vectorStore = await HNSWLib.fromDocuments(docs, new OpenAIEmbeddings({ openAIApiKey: "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" }));
...
Mayaya:`;
    ...
    // Initialize the LLM to use to answer the question.
    const model = new OpenAI({ openAIApiKey: "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", modelName: "gpt-3.5-turbo", temperature:0 });
    const projetPath = __dirname.split(path.sep);
